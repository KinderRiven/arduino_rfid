/********************************************************************************
** Form generated from reading UI file 'ktable.ui'
**
...
public:
    ...
    void setupUi(QWidget *kTable)
    {
        if (kTable->objectName().isEmpty())
            kTable->setObjectName(QStringLiteral("kTable"));
        kTable->resize(280, 740);
        verticalLayoutWidget_2 = new QWidget(kTable);
        verticalLayoutWidget_2->setObjectName(QStringLiteral("verticalLayoutWidget_2"));
        verticalLayoutWidget_2->setGeometry(QRect(10, 10, 263, 71));
        ...
        label_2 = new QLabel(kTable);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(0, 0, 281, 12));
        QPalette palette1;
        ...
        label_3 = new QLabel(kTable);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(0, 730, 281, 12));
        QPalette palette2;
        ...
        label_4 = new QLabel(kTable);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(0, 10, 12, 721));
        QPalette palette3;
        ...
        label_5 = new QLabel(kTable);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(270, 0, 12, 741));
        QPalette palette4;
        ...
        verticalLayoutWidget = new QWidget(kTable);
        verticalLayoutWidget->setObjectName(QStringLiteral("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(10, 90, 261, 601));
        ...
        tableView->horizontalHeader()->setDefaultSectionSize(280);
        tableView->horizontalHeader()->setMinimumSectionSize(280);
        tableView->verticalHeader()->setDefaultSectionSize(50);

        verticalLayout_3->addWidget(tableView);

        label_6 = new QLabel(kTable);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(0, 80, 281, 12));
        QPalette palette5;
        ...
        button_close = new QPushButton(kTable);
        button_close->setObjectName(QStringLiteral("button_close"));
        button_close->setGeometry(QRect(130, 690, 141, 41));
        QFont font2;
        font2.setFamily(QStringLiteral("SAO UI"));
        font2.setPointSize(18);
        font2.setBold(true);
        font2.setWeight(75);
        button_close->setFont(font2);
        QIcon icon;
        icon.addFile(QStringLiteral("Resources/image/NO.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_close->setIcon(icon);
        button_close->setIconSize(QSize(35, 35));
        button_update = new QPushButton(kTable);
        button_update->setObjectName(QStringLiteral("button_update"));
        button_update->setGeometry(QRect(10, 690, 131, 41));
        button_update->setFont(font2);
        QIcon icon1;
        icon1.addFile(QStringLiteral("Resources/image/OK.png"), QSize(), QIcon::Normal, QIcon::Off);
        button_update->setIcon(icon1);
        button_update->setIconSize(QSize(35, 35));

        retranslateUi(kTable);

        QMetaObject::connectSlotsByName(kTable);
    } // setupUi

    void retranslateUi(QWidget *kTable)
    {
        kTable->setWindowTitle(QApplication::translate("kTable", "Form", 0));
        label->setText(QApplication::translate("kTable", "      Card Records", 0));
        ...
        button_update->setText(QString());
    } // retranslateUi

};

namespace Ui {
    class kTable: public Ui_kTable {};
} // namespace Ui
