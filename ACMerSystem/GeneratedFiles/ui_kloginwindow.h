...
public:
    ...
    void setupUi(QWidget *kLoginWindow)
    {
        ...
        labTitle->setGeometry(QRect(270, 20, 201, 51));
        QPalette palette1;
        ...
        butLogin->setGeometry(QRect(260, 210, 111, 41));
        QFont font3;
        font3.setFamily(QStringLiteral("SAO UI"));
        font3.setPointSize(16);
        font3.setBold(true);
        font3.setWeight(75);
        butLogin->setFont(font3);
        QIcon icon;
        ...
        butExit->setGeometry(QRect(400, 210, 111, 41));
        butExit->setFont(font3);
        QIcon icon1;
        ...
        label_2->setGeometry(QRect(0, 270, 580, 16));
        QPalette palette3;
        ...
        label_3->setGeometry(QRect(0, 0, 16, 281));
        QPalette palette4;
        ...
        label_4->setGeometry(QRect(565, 10, 15, 271));
        QPalette palette5;
    ...
    void retranslateUi(QWidget *kLoginWindow)
    {
        ...
        labTitle->setText(QApplication::translate("kLoginWindow", "ACMerSystem", 0));
